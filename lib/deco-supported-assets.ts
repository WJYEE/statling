 ...
 */
export type DecoUnlockSource = { type: 'default' } | { type: 'level_gift'; level: number }
...
export const SUPPORTED_DECO_ASSETS: SupportedDecoAsset[] = [
  ...
  { id: '마법사모자', name: '마법사모자', src: `${DECO_SUPPORTED_BASE}/마법사모자.png`, naturalWidth: 197, naturalHeight: 198, unlockSource: { type: 'level_gift', level: 20 } },
  ...
  { id: '마술모자', name: '마술모자', src: `${DECO_SUPPORTED_BASE}/마술모자.png`, naturalWidth: 1254, naturalHeight: 1254, unlockSource: { type: 'level_gift', level: 15 } },
  ...
  { id: '벚꽃머리핀', name: '벚꽃머리핀', src: `${DECO_SUPPORTED_BASE}/벚꽃머리핀.png`, naturalWidth: 1254, naturalHeight: 1254, unlockSource: { type: 'level_gift', level: 30 } },
  ...
  { id: '별 머리핀', name: '별 머리핀', src: `${DECO_SUPPORTED_BASE}/별 머리핀.png`, naturalWidth: 1254, naturalHeight: 1254, unlockSource: { type: 'level_gift', level: 35 } },
  // Lv.45 level-gift reward.
  { id: '별빛머플러', name: '별빛머플러', src: `${DECO_SUPPORTED_BASE}/별빛머플러.png`, naturalWidth: 1254, naturalHeight: 1254, unlockSource: { type: 'level_gift', level: 45 } },
  ...
  { id: '새싹', name: '새싹', src: `${DECO_SUPPORTED_BASE}/새싹.png`, naturalWidth: 1254, naturalHeight: 1254, unlockSource: { type: 'level_gift', level: 5 } },
  ...
  { id: '작은티아라', name: '작은티아라', src: `${DECO_SUPPORTED_BASE}/작은티아라.png`, naturalWidth: 1254, naturalHeight: 1254, unlockSource: { type: 'level_gift', level: 25 } },
  // Lv.50 (MAX) level-gift reward — filename keeps its own space ("여섯빛 브로치.png"), same id===filename convention as 별 머리핀 above.
  { id: '여섯빛 브로치', name: '여섯빛 브로치', src: `${DECO_SUPPORTED_BASE}/여섯빛 브로치.png`, naturalWidth: 1254, naturalHeight: 1254, unlockSource: { type: 'level_gift', level: 50 } },
  ...
  { id: '천사링과날개', name: '천사링과날개', src: `${DECO_SUPPORTED_BASE}/천사링과날개.png`, naturalWidth: 1536, naturalHeight: 1024, unlockSource: { type: 'level_gift', level: 40 } },
  ...
  { id: '파랑귀족리본', name: '파랑귀족리본', src: `${DECO_SUPPORTED_BASE}/파랑귀족리본.png`, naturalWidth: 1254, naturalHeight: 1254, unlockSource: { type: 'level_gift', level: 10 } },
